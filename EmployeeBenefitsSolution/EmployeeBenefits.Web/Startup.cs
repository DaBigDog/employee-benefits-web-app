...
using EmployeeBenefits.Web.Data;
using EmployeeBenefits.Web.Models;
using EmployeeBenefits.Service;
using System;
using EmployeeBenefits.Database.Models;

namespace EmployeeBenefits.Web
{
    public class Startup
    {
        ...
        {
            // add the DBContext so it can be injected
            services.AddDbContext<EmployeeBenefitsContext>(options =>
                options.UseSqlServer(
                    Configuration.GetConnectionString("DefaultConnection")));

            services.AddDefaultIdentity<ApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
                .AddEntityFrameworkStores<EmployeeBenefitsContext>();

            //services.AddIdentityServer()
            //    .AddApiAuthorization<ApplicationUser, EmployeeBenefitsContext>();
